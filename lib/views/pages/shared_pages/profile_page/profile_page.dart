...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<MyProfileCubit, MyProfileState>(
      ...
      buildWhen: (previous, current) => current is! MyProfileUpdateInvoked,
      builder: (context, state) {
        if (state is MyProfileUpdateError) {
          Scaffold(
            body: Center(
                  ...
                  children: [
                    ...
                    TextFormField(
                      validator: (value) {
                        ...
                        } else if (value.trim() == widget.user.name.trim()) {
                    ...
                    TextFormField(
                      ...
                      validator: (value) {
                        if (value == null || value.isEmpty) {
                          ...
                          } else if (value.trim() == widget.user.email.trim()) {
